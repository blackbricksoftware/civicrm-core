  ...
  {* Put PayPal Express button after customPost block since it's the submit button in this case. *}
    ...
    <div id="paypalExpress">
      ...
      <fieldset class="crm-public-form-item crm-group paypal_checkout-group">
        ...
        <div class="section">
          <div class="crm-public-form-item crm-section paypalButtonInfo-section clearfix">
            <div class="content">
              <span class="description">{ts}Click the PayPal button to continue.{/ts}</span>
            </div>
          </div>
          <div class="crm-public-form-item crm-section {$expressButtonName}-section clearfix">
            <div class="content">
...
{else}
  ...
  <div class="crm-public-form-item crm-section {$form.$n.name}-section clearfix">
  ...
  <fieldset class="panel crm-public-form-item crm-group payment_options-group" style="display:none;">
    <legend>{ts}Payment Options{/ts}</legend>
    <div class="crm-public-form-item crm-section payment_processor-section clearfix">
  ...
  {if $is_pay_later}
  <fieldset class="panel crm-public-form-item crm-group pay_later-group">
    <legend>{ts}Payment Options{/ts}</legend>
    <div class="crm-public-form-item crm-section pay_later_receipt-section clearfix">
  ...
  <br>
  <div id="crm-submit-buttons" class="crm-submit-buttons text-right">
